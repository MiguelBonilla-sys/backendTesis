"""
ThreatIntelService — consulta concurrente a VirusTotal v3, URLScan.io y
Google Safe Browsing v4.

Fórmula de agregación:
    S_TI = W_VT * S_VT + W_URLSCAN * S_URLScan + W_GSB * S_GSB

Pesos definidos en core/constants.py (W_VT=0.50, W_URLSCAN=0.30, W_GSB=0.20).
...
class ThreatIntelService:
    ...
    async def analyze(self, url: str, domain: str) -> TIResult:
        ...
        # --- 3. Consulta concurrente a las 3 APIs ----------------------------
        vt_score, urlscan_score, gsb_score = await asyncio.gather(
        ...
        s_ti = W_VT * vt_score + W_URLSCAN * urlscan_score + W_GSB * gsb_score
